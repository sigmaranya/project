...
class MathsGame:
    ...
    def add_quit_button(self):
        """Add a Quit button to the current screen."""
        quit_button = tk.Button(self.root, text="Quit", font=("Arial", 14), command=self.quit_game, bg="red", fg="red")
        quit_button.place(x=WINDOW_WIDTH - 100, y=WINDOW_HEIGHT - 50)
